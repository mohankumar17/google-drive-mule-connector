...
| File Name a| String |  +++Provide the name of the file to upload+++ |  | *x*{nbsp}
| File Path a| String |  +++Provide the path of the file to upload+++ |  | *x*{nbsp}
| File Extension a| String |  +++Provide the extension of the file+++ |  | *x*{nbsp}
